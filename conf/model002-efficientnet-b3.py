workdir = './model/model002-efficientnet-b3'# contrast设置为不参与
seed = 20
apex = True
...
contrast = dict(name='RandomBrightnessContrast', params=dict(brightness_limit=0.08, contrast_limit=0.08, p=0))
...
data = dict(
    train=dict(
        ...
        imgdir='../input/rsna-intracranial-hemorrhage-detection/stage_2_train_images',
        imgsize=imgsize,
        n_grad_acc=1,
        loader=dict(
            shuffle=True,
    ...
    test = dict(
        ...
        imgdir='../input/rsna-intracranial-hemorrhage-detection/stage_2_test_images',
        imgsize=imgsize,
        loader=dict(
            shuffle=False,
            batch_size=batch_size,
